...
export default function Settings() {
    const [profileData, setProfileData] = useState({
        ...
        firstName: 'Carlos',
        lastName: 'Silva',
        bio: 'Apaixonado por moda vintage e boas pechinchas. Vivo em Setúbal.',
        ...
        <div className="min-h-screen bg-gray-50 py-8">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-600 mt-2">Gere as tuas informações pessoais e preferências</p>
                </div>
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="flex-1">
                        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                                            ...
                                            <div>
                                                <label className="cursor-pointer">
                                                    <input
                                                        ...
                                                        className="hidden"
                                                    />
                                                    <span className="px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
                                                        Escolher foto
                                                    </span>
                                                </label>
                                ...
                                <div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="p-4 bg-red-50 rounded-lg">
                                            <button className="px-4 py-2 bg-red-600 text-white text-xs rounded-lg hover:bg-red-700">
                                                Excluir minha conta
                                            </button>
                                        </div>
                                    </div>
                            ...
                            {activeTab === 'notifications' && (
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <label className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                                            <div>
                                                <p className="font-medium text-gray-900">Vendas</p>
                            ...
                            {activeTab === 'privacy' && (
                                <div>
                                    <h2 className="text-xl font-semibold text-gray-900 mb-6">Privacidade</h2>
                                    <div className="space-y-4">
                                        <label className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                                            <div>
