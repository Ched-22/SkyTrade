                        ...
                        <div className="p-4 border-b border-gray-200">
                            <div className="relative">
                                <input
                                    ...
                                    className="w-full px-4 py-2 pl-10 bg-gray-100 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                />
                            ...
                            {conversations.map((conversation) => (
                                <div
                                    ...
                                    className={`p-4 border-b border-gray-100 cursor-pointer transition-colors hover:bg-gray-50 ${
                                        activeChat === conversation.id ? "bg-blue-50 border-l-4 border-l-blue-500" : ""
                                    }`}
                                >
                    ...
                    <div className="flex flex-col flex-1">
                        ...
                        <div className="flex-1 overflow-y-auto p-4 bg-gray-50">
                            {messages.map((message) => (
                                ...
                                >
                                    <div className={`inline-block max-w-xl rounded-2xl px-4 py-2 ${message.isOwn ? "bg-blue-600 text-white rounded-tr-none" : "bg-white text-gray-900 border border-gray-200 rounded-tl-none"}`}>
                                        <p className="text-sm">{message.content}</p>
                                        <div className={`flex items-center justify-end mt-1 ${message.isOwn ? "text-blue-200" : "text-gray-500"}`}>
                            ...
                            {isTyping && (
                                <div className="mb-4 text-left">
                                    <div className="inline-block bg-white border border-gray-200 rounded-2xl rounded-tl-none px-4 py-3">
                            ...
                            <form onSubmit={handleSendMessage} className="flex items-center space-x-3">
                                ...
                                <div className="flex-1 relative">
                                    <textarea
                                        ...
                                        className="w-full px-4 py-3 pr-12 bg-gray-100 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
                                        rows="1"
                                    />
                                    <button
                                        type="submit"
